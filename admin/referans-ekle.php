            ...
            <div class="card card-primary">
              ...
              <form action="islem.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input required type="file"  name="yorum_resim" class="custom-file-input" id="exampleInputFile">
                  ...
                  <div class="form-group">
                    <label >Yazı</label>
                    <input type="text" name="yorum_aciklama" class="form-control" >
                  </div>
                  <div class="form-group">
                    <label >Mesleği</label>
                ...
                <div class="card-footer">
                  <button type="submit" name="referansekle" class="btn btn-primary">Ekle</button>
                </div>
              </form>
            </div></div>
        </div>
